      ...
      <section className={`${style.main} container`}>
        <div className={`${style.text}`}>
          ...
          <p>
            ...
            use of Sophisticated's Website, located at herokuapp.readit.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use ReadIT if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing ReadIT, you agreed to use
            cookies in agreement with the Sophisticated's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Sophisticated and/or its licensors own the
            intellectual property rights for all material on ReadIT. All
            intellectual property rights are reserved. You may access this from
            ReadIT for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from ReadIT</li>
            <li>Sell, rent or sub-license material from ReadIT</li>
            <li>Reproduce, duplicate or copy material from ReadIT</li>
            <li>Redistribute content from ReadIT</li>
          </ul>
          ...
          <p>
            ...
            Sophisticated does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Sophisticated,its agents and/or affiliates.
            ...
            Sophisticated shall not be liable for the Comments or for any
          ...
          <p>
            Sophisticated reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Sophisticated a non-exclusive license to use,
          ...
          <p>
            ...
            Sophisticated; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Sophisticated. Please include your name, your
          ...
          <p>
            No use of Sophisticated's logo or other artwork will be allowed for
